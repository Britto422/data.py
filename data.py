...
# Dicionário para converter dias para extenso
numeros_por_extenso = {
...
def ano_por_extenso(ano):
    ...
    milhar = milhar_por_extenso(int(ano[0]))  # Primeiro dígito
    centena = int(ano[1])  # Segundo dígito
    dezena = int(ano[2])  # Terceiro dígito
    unidade = int(ano[3])  # Quarto dígito
